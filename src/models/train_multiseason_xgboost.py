...
DATA_PATH = Path("data") / "full_multiseason_dataset_with_rolling.csv"

MODEL_PATH = Path("models") / "xgboost_multiseason.pkl"

ENCODERS_PATH = Path("models") / "multiseason_feature_encoders.pkl"
